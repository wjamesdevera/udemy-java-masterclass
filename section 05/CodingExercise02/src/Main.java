 ...
 * round it and return it. For conversion and rounding, check the notes
 * in the text below.
 *
 ...
 * the argument. The result is rounded to an integer by adding 1/2, taking
 * the floor of the result after adding 1/2, and typecasting the result
 * to type long. The method returns the value of the argument rounded to the
 * nearest int value.
 *
 * USAGE EXAMPLE:
 *
...
public class Main {
    ...
    public static void printConversion(double kilometersPerHour) {
        ...
        String outputFormat = kilometersPerHour + " km/h = " + milesPerHour + " mi/h";
