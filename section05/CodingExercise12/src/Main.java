 ...
 *
 *
 * Write a method isCatPlaying that has 2 parameters. Method needs to
 * return true if the cat is playing, otherwise return false
 *
 ...
 *
 * * isCatPlaying(false, 35); should return true since temperature is in
 * range 25 - 35
 *
 *
 * NOTES
...
public class Main {
    ...
    public static boolean isCatPlaying(boolean summer, int temperature) {
        boolean firstCondition = (!summer && (temperature >= 25 && temperature <= 35));
        boolean secondCondition = (summer && (temperature >= 25 && temperature <= 45));
